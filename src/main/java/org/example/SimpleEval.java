...
public class SimpleEval {
    ...
    public static void main (String[] args){
        ...
        whiteBoard.loadFromFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
        int whiteEval = simpleEval.positionalEvaluation(whiteBoard);

        Board blackBoard = new Board();
        blackBoard.loadFromFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1");
        int blackEval = simpleEval.positionalEvaluation(blackBoard);

        System.out.println("White Eval: " + whiteEval + ", Black Eval: " + blackEval);
    }
}
