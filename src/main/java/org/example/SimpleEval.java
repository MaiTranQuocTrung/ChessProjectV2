...
public class SimpleEval {
    ...
    private final int [] pawn_table_md = {
            0,   0,   0,   0,   0,   0,  0,   0,
    ...
    private final int [] bishop_table_md = {
    ...
    private final int [] knight_table_md = {
    ...
    private final int [] rook_table_md = {
    ...
    private final int [] queen_table_md = {
    ...
    private final int [] king_table_md = {
    ...
    private final int [] pawn_table_eg = {
            0,   0,   0,   0,   0,   0,   0,   0,
    ...
    private final int [] knight_table_eg = {
    ...
    private final int [] bishop_table_eg = {
    ...
    private final int [] rook_table_eg = {
    ...
    private final int [] queen_table_eg = {
    ...
    private final int [] king_table_eg = {
    ...
    public static void main (String[] args){
        ...
        long bitboard = board.getBitboard(Piece.WHITE_PAWN);
        for (int i = 0; i < 64; i++){
            if ((bitboard & (1L << i)) != 0) {
